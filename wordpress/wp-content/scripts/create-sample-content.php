...
$projects_data = [
    [
        'en' => [
            'title' => 'Neusatz Aqua Fish Farm',
            'content' => 'A state-of-the-art RAS facility in Serbia producing premium quality fish in a sustainable and efficient manner.',
            'acf' => [
                'project_client' => 'Neusatz Aqua',
                'project_location' => 'Serbia',
                'project_year' => '2024',
                'project_size' => '5,000 m²',
                'project_challenge' => 'Design and implement a modern RAS facility capable of producing 500 tons of fish annually while meeting strict environmental regulations.',
                'project_solution' => 'We designed a comprehensive RAS system with advanced biofilters, automated feeding systems, and real-time water quality monitoring. The facility includes separate grow-out tanks, a quarantine area, and efficient water treatment.',
                'project_results' => 'Successfully launched in Q1 2024. The facility is now producing high-quality fish with 95% survival rate and 30% less water consumption compared to traditional methods.',
                'project_featured' => true
            ]
        ],
        'uk' => [
            'title' => 'Рибна ферма Neusatz Aqua',
            'content' => 'Сучасний об\'єкт RAS у Сербії, що виробляє рибу преміум-якості сталим та ефективним способом.',
            'acf' => [
                'project_client' => 'Neusatz Aqua',
                'project_location' => 'Сербія',
                'project_year' => '2024',
                'project_size' => '5,000 м²',
                'project_challenge' => 'Проектування та впровадження сучасного об\'єкта RAS, здатного виробляти 500 тонн риби щорічно, відповідаючи суворим екологічним нормам.',
                'project_solution' => 'Ми спроектували комплексну систему RAS з передовими біофільтрами, автоматизованими системами годівлі та моніторингом якості води в реальному часі. Об\'єкт включає окремі басейни для вирощування, карантинну зону та ефективну систему очищення води.',
                'project_results' => 'Успішно запущено у 1 кварталі 2024 року. Об\'єкт зараз виробляє високоякісну рибу з виживаністю 95% і на 30% меншим споживанням води порівняно з традиційними методами.',
                'project_featured' => true
            ]
        ]
    ],
    [
        'en' => [
            'title' => 'Alpine Trout Farm',
            'content' => 'Premium trout production facility in the Austrian Alps utilizing natural spring water and modern aquaculture technology.',
            'acf' => [
                'project_client' => 'Alpine Aqua',
                'project_location' => 'Austria',
                'project_year' => '2023',
                'project_size' => '3,000 m²',
                'project_challenge' => 'Expand existing trout farm capacity while maintaining premium quality standards and working within environmental constraints of an Alpine location.',
                'project_solution' => 'Implemented a hybrid system combining flow-through with partial recirculation. Designed specialized tanks for different life stages and installed advanced monitoring systems adapted for cold-water species.',
                'project_results' => 'Production increased by 60% while maintaining water quality. The farm now produces 180 tons annually of premium-grade rainbow trout with excellent feed conversion ratios.',
                'project_featured' => false
            ]
        ],
        'uk' => [
            'title' => 'Альпійська форелева ферма',
            'content' => 'Преміум-об\'єкт з виробництва форелі в Австрійських Альпах, що використовує природну джерельну воду та сучасні аквакультурні технології.',
            'acf' => [
                'project_client' => 'Alpine Aqua',
                'project_location' => 'Австрія',
                'project_year' => '2023',
                'project_size' => '3,000 м²',
                'project_challenge' => 'Розширення існуючої потужності форелевої ферми при збереженні стандартів преміум-якості та роботі в межах екологічних обмежень альпійського розташування.',
                'project_solution' => 'Впроваджено гібридну систему, що поєднує проточну з частковою рециркуляцією. Спроектовано спеціалізовані басейни для різних стадій життя та встановлено передові системи моніторингу, адаптовані для холодноводних видів.',
                'project_results' => 'Виробництво збільшилося на 60% при збереженні якості води. Ферма зараз виробляє 180 тонн щорічно райдужної форелі преміум-класу з відмінними коефіцієнтами конверсії корму.',
                'project_featured' => false
            ]
        ]
    ]
...
foreach ($projects_data as $project_pair) {
    ...
    foreach ($project_pair['en']['acf'] as $field => $value) {
        update_field($field, $value, $en_project_id);
    }
    ...
    foreach ($project_pair['uk']['acf'] as $field => $value) {
        update_field($field, $value, $uk_project_id);
    }
