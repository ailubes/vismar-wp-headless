...
<li>Zero-discharge water management</li>
  ...
  try {
    ...
    console.log('Standing Biomass:', project.technicalSpecifications?.projectStandingBiomass, project.technicalSpecifications?.projectBiomassUnit);
    console.log('Water Volume:', project.technicalSpecifications?.projectWaterVolume, project.technicalSpecifications?.projectWaterVolumeUnit);
    console.log('Facility Size:', project.technicalSpecifications?.projectFacilitySize, project.technicalSpecifications?.projectFacilitySizeUnit);
    console.log('\n=== Financial Performance ===');
